...
public class TelaCadastroPrestador {
    public static Scene criarTela(){
        ...
        Label tituloTelaCadastro = new Label("Cadastro Prestador");
        telaCadastroPrestador.add(tituloTelaCadastro, 1, 0);

        //Campos tela de cadastro
        Label labelEntradaEmail = new Label("E-mail: ");
        telaCadastroPrestador.add(labelEntradaEmail, 1, 1);
        TextField entradaEmail = new TextField();
        telaCadastroPrestador.add(entradaEmail, 1, 2);

        Label labelEntradaSenha = new Label("Senha: ");
        telaCadastroPrestador.add(labelEntradaSenha, 1, 3);
        PasswordField entradaSenha = new PasswordField();
        telaCadastroPrestador.add(entradaSenha, 1, 4);

        //Botão para cadastrar
        Button botaoCadastrar = new Button("Cadastrar");
        telaCadastroPrestador.add(botaoCadastrar,1 ,5 );
        //Cadastra o usuário
